...
# Nội dung Chương 1 trích xuất từ web
...
# Nội dung Chương 2 trích xuất từ web
...
# 1. Vá Chương 1
text = re.sub(r"(==================== Chương 1 ====================)\n\n--- Không tìm thấy nội dung ---", r"\1\n\n" + content_chap1, text)

# 2. Chèn Chương 2 vào sau Chương 1
if "==================== Chương 2 ====================" not in text:
    target_pattern = r"(==================== Chương 1 ====================.*?)(==================== Chương 3 ====================)"
    replacement = r"\1\n\n==================== Chương 2 ====================\n\n" + content_chap2 + r"\n\n\2"
    text = re.sub(target_pattern, replacement, text, flags=re.DOTALL)

with open(file_path, 'w', encoding='utf-8') as f:
    f.write(text)

print("Done: Patched Chapter 1 and inserted Chapter 2.")
